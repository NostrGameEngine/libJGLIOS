...
public final class IosAL {
    ...
    public static native void alDeleteSources(int numSources, IntBuffer sources, long sourcesOffset);
    public static native void alGenBuffers(int numBuffers, IntBuffer buffers, long buffersOffset);
    public static native void alDeleteBuffers(int numBuffers, IntBuffer buffers, long buffersOffset);
    public static native void alSourceStop(int source);
    public static native void alSourcei(int source, int param, int value);
    public static native void alBufferData(int buffer, int format, ByteBuffer data, long dataOffset, int size, int frequency);
    ...
    public static native void alSourceUnqueueBuffers(int source, int numBuffers, IntBuffer buffers, long buffersOffset);
    public static native void alSourceQueueBuffers(int source, int numBuffers, IntBuffer buffers, long buffersOffset);
    public static native void alListener(int param, FloatBuffer data, long dataOffset);
