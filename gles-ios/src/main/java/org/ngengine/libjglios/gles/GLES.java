...
public final class GLES {
    ...
    */
    ...
    public static native void glBufferData(int target, long size, Buffer data, long dataOffset, int usage);
    ...
    public static native void glCompressedTexImage2D(int target, int level, int internalformat, int width, int height, int border, int imageSize, Buffer data, long dataOffset);
    ...
    public static native void glCompressedTexImage3D(int target, int level, int internalformat, int width, int height, int depth, int border, int imageSize, Buffer data, long dataOffset);
    ...
    public static native void glCompressedTexSubImage2D(int target, int level, int xoffset, int yoffset, int width, int height, int format, int imageSize, Buffer data, long dataOffset);
    ...
    public static native void glCompressedTexSubImage3D(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int imageSize, Buffer data, long dataOffset);
    ...
    public static native void glDeleteBuffers(int n, IntBuffer buffers, long buffersOffset);
    ...
    public static native void glDeleteFramebuffers(int n, IntBuffer framebuffers, long framebuffersOffset);
    ...
    public static native void glDeleteQueries(int n, IntBuffer ids, long idsOffset);
    ...
    public static native void glDeleteRenderbuffers(int n, IntBuffer renderbuffers, long renderbuffersOffset);
    ...
    public static native void glDeleteTextures(int n, IntBuffer textures, long texturesOffset);
    ...
    public static native void glGenBuffers(int n, IntBuffer buffers, long buffersOffset);
    ...
    public static native void glGenFramebuffers(int n, IntBuffer framebuffers, long framebuffersOffset);
    ...
    public static native void glGenQueries(int n, IntBuffer ids, long idsOffset);
    ...
    public static native void glGenRenderbuffers(int n, IntBuffer renderbuffers, long renderbuffersOffset);
    ...
    public static native void glGenTextures(int n, IntBuffer textures, long texturesOffset);
    ...
    public static native void glReadPixels(int x, int y, int width, int height, int format, int type, Buffer pixels, long pixelsOffset);
    ...
    public static native void glVertexAttribPointer(int index, int size, int type, byte normalized, int stride, Buffer pointer, long pointerOffset);
