...
public final class GLES {
    ...
    */
    ...
    public static native void glBufferData(int target, long size, Buffer data, int usage);
    ...
    public static native void glBufferSubData(int target, long offset, long size, Buffer data);
    ...
    public static native void glVertexAttribPointer(int index, int size, int type, byte normalized, int stride, Buffer pointer);
